const { addDuePayment, updatePaymentAmount, deletePaymentByAdmin } = require('./payments.service');
...
module.exports = { addPayment, cancelPayment, updatePayment, adminDeletePayment };